...
# Customize sparsity and pruning norm
custom_sparsity = 0.7
custom_prune_norm = 'L1'  # Choose 'L1' or 'L2'

# Create an instance of the pruner class with customized parameters
device = 'cuda' if torch.cuda.is_available() else 'cpu'
pruner_instance = Pruner(custom_yolov7_model, device=device, sparsity=custom_sparsity, prune_norm=custom_prune_norm)
